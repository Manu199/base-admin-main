                                ...
                                <div class="mb-4 row justify-content-center">
                                    <div class="col">
                                        <input id="name" type="text" placeholder="Name"
                                            class="form-control custom-checkbox @error('name') is-invalid @enderror"
                                ...
                                <div class="mb-4 row justify-content-center">
                                    <div class="col">
                                        <input id="lastname" type="text" placeholder="Lastname"
                                            class="form-control custom-checkbox @error('lastname') is-invalid @enderror"
                                ...
                                <div class="mb-4 row justify-content-center">
                                    <div class="col">
                                        <input id="phone_number" type="tel" placeholder="Tel +00 123456789"
                                            class="form-control custom-checkbox @error('phone_number') is-invalid @enderror"
